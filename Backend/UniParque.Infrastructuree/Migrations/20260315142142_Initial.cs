    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingBranches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplaceByJwtId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSections_ParkingBranches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "ParkingBranches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ParkingSubSections",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SubSection = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingSubSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParkingSubSections_ParkingSections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingPlaces_ParkingSubSections_SubSectionId",
                        column: x => x.SubSectionId,
                        principalTable: "ParkingSubSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_ParkingPlaces_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingPlaces_SubSectionId",
                table: "ParkingPlaces",
                column: "SubSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSections_BranchId",
                table: "ParkingSections",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSubSections_SectionId",
                table: "ParkingSubSections",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_EstimatedArrivalTime",
                table: "Reservations",
                column: "EstimatedArrivalTime");
